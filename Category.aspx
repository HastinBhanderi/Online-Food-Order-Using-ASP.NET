                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control"
                                                            placeholder="Enter Category Name" reruired></asp:TextBox>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:FileUpload ID="fuCategortImage" runat="server" CssClass="form-control"
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                            ...
                                            <div class="cart-block table-border-style">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge bg-danger" CommandArgument='<%# Eval("CategoryId") %>' CommandName="delete" OnClientClick="return confirm('Do you want to delete thiscategory?');">
                                                                        <i class="ti-trash"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
