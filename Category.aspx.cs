...
namespace Foodie.Admin
{
    public partial class Category : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (fuCategortImage.HasFile)
            {
                if (Utils.IsValidExtension(fuCategortImage.FileName))
                {
                    Guid obj = Guid.NewGuid();
                    fileExtension = Path.GetExtension(fuCategortImage.FileName);
                    imagePath = "Images/Category/" + obj.ToString() + fileExtension;
                    fuCategortImage.PostedFile.SaveAs(Server.MapPath("~/Images/Category/") + obj.ToString() + fileExtension);
